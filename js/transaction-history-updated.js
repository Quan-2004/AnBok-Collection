// Updated Transaction History Management
class UpdatedTransactionHistoryManager {
    constructor() {
        this.database = null;
        this.init();
    }
...
// Initialize updated transaction history manager
$(document).ready(function() {
    window.updatedTransactionHistoryManager = new UpdatedTransactionHistoryManager();
});

// Override the old loadTransactionHistory function
window.loadTransactionHistory = function() {
    if (window.updatedTransactionHistoryManager) {
        window.updatedTransactionHistoryManager.loadTransactionHistory();
    }
};
